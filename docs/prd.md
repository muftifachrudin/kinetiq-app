...
- **Market structure (BOS/CHoCH)** — ditemukan dari chart founder, dipakai bareng fib+gann tapi belum ada di scope resmi PRD B.6. Belum diputuskan apakah bagian tak terpisahkan `fib_gann_timing` atau skill terpisah (`market_structure.py`).
