...
- **Triple-barrier labeling (bag. 5d) MASIH BELUM diimplementasi** — scope-nya beda kelas dari 5a-5c (butuh scikit-learn + data historis riil, bukan pure function atas 1 leg candle), sengaja dipisah jadi round tersendiri biar gak nyampur PR besar yg susah direview. Lihat catatan verifikasi klaim MARKOVIZ di atas — harus ditulis dari nol, gak ada yg bisa langsung di-reuse.
