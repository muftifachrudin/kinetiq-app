...
- ~~Kalibrasi Gann Fan price-per-time-unit~~ — **RESOLVED**: founder konfirmasi opsi 1 (fixed reference scale dari ATR/swing range, bukan approximate viewport TradingView). Gann Fan sendiri **belum diimplementasi** (round berikutnya) — kalibrasinya sekarang tinggal dieksekusi, bukan lagi keputusan terbuka.
